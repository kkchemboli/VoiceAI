...
async def entrypoint(ctx: JobContext):
    ...
    initial_ctx.add_message(
        ...
        content=(
            ...
            "Agent: The price of the iPhone Repairing course is Fifty Thousand rupees and with one course you get a 40% discount, it will cost you Thirty Thousand rupees and if you choose another course as well you'll get a 50% discount.\n"
